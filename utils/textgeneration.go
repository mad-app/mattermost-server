...
Inline Image with link, alt text, and hover text: ![Build Status](https://travis-ci.org/mad-app/mattermost-server.svg?branch=master)](https://travis-ci.org/mad-app/mattermost-server)
